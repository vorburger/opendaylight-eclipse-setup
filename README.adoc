...
What do do if they Dynamic Working Sets which automatically split projects into *-build and *-code got messed up because you closed & re-opened some projects?::
