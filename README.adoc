...
Q: Why do I not see the "Projects" lists, only the "Product" selection?

A: Switch the Advanced Mode, and Click Next; watch https://youtu.be/BLW8aOh6WeQ?t=1m42s


Q: Why do I not see OpenDaylight.org in the Projects lists, only the Eclipse & GitHub Projects?

A: Use the "Select Catalogs" icon in the upper right hand corner, OpenDaylight may be filtered.
